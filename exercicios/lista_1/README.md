...
### QUESTÃO 2 - Posição e existência de um elemento
...
### QUESTÃO 3 - Obter um elemento em uma posição específica

a) Retornar o elemento na posição especificada, *se o índice não existir, retornar null*.
 
### QUESTÃO 4 - Remover elemento de uma posição específica
