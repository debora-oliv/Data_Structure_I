...
public class Programa {
    public static void main(String[] args) throws FileNotFoundException {
        Scanner sc = new Scanner(new File("exercicios/list.exercicio_4/entradaInvest.txt"));
        PrintWriter pw = new PrintWriter("exercicios/list.exercicio_4/saidaInvest.txt");
